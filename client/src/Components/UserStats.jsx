...
const UserStats = () => {
  ...
  // const userOrders = completed.filter((order) => order.user === user.email); // Adjust property name if different in your data

  // const userOrders = async () => {
  //     if (completed) {
  //     // completed.email === user.email
  // return completed.filter((order) => order.email === user.email); // Filter orders based on the logged-in user's email
  //     }
  //   };
  return (
    <div className='grid grid-cols-2 gap-6 border-b border-t border-teal-300 py-4  md:py-8 lg:grid-cols-4 xl:gap-16'>
      <div>
        <svg
