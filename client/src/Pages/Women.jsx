  ...
  return (
    <div className=''>
      <div className='mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8'>
        <h2 className='text-2xl font-bold tracking-tight text-white'>Women</h2>
            ...
            .map((product, index) => (
              ...
              >
                <img
                  ...
                  className=' image aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80'
                />
